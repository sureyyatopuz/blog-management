  ...
  return (
    <>
      ...
      <div className="flex justify-center bg-gray-100 ">
        <div className="flex w-3/4 justify-center bg-gray-100">
          <div className="flex justify-center bg-slate-500 mt-10 mb-16">
            ...
            {blogData.slice(5, 10).map((item, index) => (
              <div key={index} className="flex bg-red-600 gap-x-4 w-2/5 ml-4">
                <div className="flex ">
                  <Image
                    width={100}
                ...
                <div className="">
                  <h6 className="text-base text-red-700">{item.categoryName}</h6>
                  <p className="line-3-clamp font-semibold">
                    {item.title}
                  </p>
                </div>
              </div>
